...
## Project Structure
    ...
    ├── testapiautoconnect_121518  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_121518`
...
2. Clone this repo and `cd testapiautoconnect_121518`
